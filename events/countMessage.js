...
module.exports = {
    ...
    async execute(client, message) {
        ...
        try{
                    ...
                    if (number && number != 0) {
                        ...
                        if (message.author.id === count.last_count_userid) {
                            ...
                            try {
                                ...
                                await message.send("Cannot delete message, fix bot's permissions!")
                                return console.log(err);
                            }
                        }
            ...
            try {
                await message.reply("Error occured, try fixing your bot's permissions, if it does not work try again later or contact the support server!");
            } catch (err) {
                console.log(err)
            }
        }
